...
function openLightbox(img) {
  ...
  lightbox.innerHTML = '<img src="' + img.src + '" class="lightbox-img"><span class="lightbox-close" onclick="closeLightbox()">&times;</span>';
  document.body.appendChild(lightbox);
  document.body.style.overflow = 'hidden'; // Mencegah scrolling pada latar belakang saat lightbox dibuka
}

function closeLightbox() {
  var lightbox = document.querySelector('.lightbox');
  lightbox.parentNode.removeChild(lightbox);
  document.body.style.overflow = ''; // Mengembalikan scrolling pada latar belakang setelah lightbox ditutup
}
